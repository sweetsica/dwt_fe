    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3 row">
                    <div class="col-sm-12 d-flex align-items-center">
                        <label for="staticEmail" class="col-form-label" style="padding-right:4px;">Vấn đề tồn đọng </label>
                        <div class="w-100" style="flex:1;overflow:hidden">
                            <div contenteditable="true" class="contenteditable" placeholder="Vui lòng nêu vấn đề tồn đọng tại đây"></div>
                        </div>
                    </div>
                </div>
                <div class="mb-3 row">
                    <div class="col-sm-7 d-flex  align-items-center">
                        <label for="inputPassword" class="col-form-label" style="padding-right:4px;flex:1">Cấp giải quyết</label>
                        <div style="flex:2">
                            <select class="selectpicker" title="Chọn cấp giải quyết" data-width="90%">
                    ...
                    <div class="col-sm-5 d-flex  align-items-center">
                        <label for="inputPassword" class="col-form-label" style="padding-right:4px;">Thời hạn</label>
                        <div style="flex:1">
                            <input id="datetimepicker3" value="<?php echo date('d/m/Y'); ?>" class="form-control"  type="text">
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger ps-4 pe-4">Gửi</button>
            </div>
        </div>
    </div>
</div>